...
* [**Java**: *Building Your Own Kafka-like System From Scratch: A Step-by-Step Guide*](https://github.com/buildthingsuseful/build-your-own-kafka) ⭐ 121 | 🐛 2 | 🌐 Java | 📅 2025-03-13

#### Build your own `3D Renderer`

* [**C++**: *How OpenGL works: software rendering in 500 lines of code*](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,165 | 🐛 4 | 🌐 C++ | 📅 2026-07-29
...
* [**Python**: *A Large Language Model (LLM)*](https://github.com/rasbt/LLMs-from-scratch) ⭐ 104,144 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-08-29
* [**Python**: *RAG for Document Search*](https://github.com/langchain-ai/rag-from-scratch) ⭐ 9,229 | 🐛 39 | 🌐 Jupyter Notebook | 📅 2025-06-26
...
* [**C / Python**: *Build your own VPN/Virtual Switch*](https://github.com/peiyuanix/build-your-own-zerotier) ⭐ 633 | 🐛 4 | 🌐 C | 📅 2024-02-20
...
* [**Python**: *Build Deep Learning From Scratch (reimplement PyTorch internals across 34 stages)*](https://github.com/roiamiel1/Build-Deep-Learning-From-Scratch) ⭐ 44 | 🐛 0 | 🌐 Python | 📅 2026-07-11
...
* [**C**: *How to create an OS from scratch*](https://github.com/cfenollosa/os-tutorial) ⭐ 30,681 | 🐛 130 | 🌐 C | 📅 2026-02-04
* [**C**: *Learning operating system development using Linux kernel and Raspberry Pi*](https://github.com/s-matyukevich/raspberry-pi-os) ⭐ 13,921 | 🐛 66 | 🌐 C | 📅 2024-03-29
* [**C**: *Build a minimal multi-tasking kernel for ARM from scratch*](https://github.com/jserv/mini-arm-os) ⭐ 1,256 | 🐛 2 | 🌐 C | 📅 2025-12-14
...
* [**Verilog**: *From Blinker to RISC-V*](https://github.com/BrunoLevy/learn-fpga/tree/master/FemtoRV/TUTORIALS/FROM_BLINKER_TO_RISCV) ⭐ 3,660 | 🐛 58 | 🌐 C++ | 📅 2025-11-18

#### Build your own `Programming Language`

* [**JavaScript**: *The Super Tiny Compiler*](https://github.com/jamiebuilds/the-super-tiny-compiler) ⭐ 28,569 | 🐛 16 | 🌐 JavaScript | 📅 2024-02-19
* [**C**: *A journey explaining how to build a compiler from scratch*](https://github.com/DoctorWkt/acwj) ⭐ 13,393 | 🐛 25 | 🌐 C | 📅 2026-06-06
...
* [**JavaScript**: *JavaScript Algorithms and Data Structures*](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,584 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26
...
* [**Lua**: *Building a CDN from Scratch to Learn about CDN*](https://github.com/leandromoreira/cdn-up-and-running) ⭐ 3,689 | 🐛 2 | 🌐 Lua | 📅 2026-01-21
...
* [**(any)**:  build-your-own-x-vibe-coding: BYOX-style tutorials adapted for vibe coding](https://github.com/inFaaa/build-your-own-x-vibe-coding) ⭐ 98 | 🐛 0 | 🌐 Python | 📅 2025-09-05
...
* Submissions welcome, just send a PR, or [create an issue](https://github.com/codecrafters-io/build-your-own-x/issues/new) ⭐ 544,434 | 🐛 640 | 🌐 Markdown | 📅 2026-07-14
* Help us review [pending submissions](https://github.com/codecrafters-io/build-your-own-x/issues) ⭐ 544,434 | 🐛 640 | 🌐 Markdown | 📅 2026-07-14 by leaving comments and "reactions"

## Origins & License

[![CC0](https://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)

This repository is the work of [many contributors](https://github.com/codecrafters-io/build-your-own-x/graphs/contributors) ⭐ 544,434 | 🐛 640 | 🌐 Markdown | 📅 2026-07-14. It was started by [Daniel Stefanovic](https://github.com/danistefanovic), and is now maintained by [CodeCrafters, Inc.](https://codecrafters.io) To the extent possible under law, [CodeCrafters, Inc.](https://codecrafters.io) has waived all copyright and related or neighboring rights to this work.
