...
* [**Java**: *Building Your Own Kafka-like System From Scratch: A Step-by-Step Guide*](https://github.com/buildthingsuseful/build-your-own-kafka) ⭐ 137 | 🐛 2 | 🌐 Java | 📅 2025-03-13

#### Build your own `3D Renderer`

* [**C++**: *How OpenGL works: software rendering in 500 lines of code*](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,265 | 🐛 4 | 🌐 C++ | 📅 2026-07-29
...
* [**Python**: *A Large Language Model (LLM)*](https://github.com/rasbt/LLMs-from-scratch) ⭐ 105,266 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-09-17
* [**Python**: *RAG for Document Search*](https://github.com/langchain-ai/rag-from-scratch) ⭐ 9,351 | 🐛 43 | 🌐 Jupyter Notebook | 📅 2025-06-26
...
* [**Python**: *Build Deep Learning From Scratch (reimplement PyTorch internals across 34 stages)*](https://github.com/roiamiel1/Build-Deep-Learning-From-Scratch) ⭐ 55 | 🐛 0 | 🌐 Python | 📅 2026-07-11
...
* [**C**: *How to create an OS from scratch*](https://github.com/cfenollosa/os-tutorial) ⭐ 30,711 | 🐛 129 | 🌐 C | 📅 2026-02-04
...
* [**Verilog**: *From Blinker to RISC-V*](https://github.com/BrunoLevy/learn-fpga/tree/master/FemtoRV/TUTORIALS/FROM_BLINKER_TO_RISCV) ⭐ 3,690 | 🐛 59 | 🌐 C++ | 📅 2025-11-18
...
* [**(any)**: *mal - Make a Lisp*](https://github.com/kanaka/mal#mal---make-a-lisp) ⭐ 10,734 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22
...
* [**JavaScript**: *JavaScript Algorithms and Data Structures*](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,778 | 🐛 407 | 🌐 JavaScript | 📅 2026-07-26
...
* [**C**: *Learn how to write a hash table in C*](https://github.com/jamesroutley/write-a-hash-table) ⭐ 4,388 | 🐛 27 | 📅 2023-12-16
...
* Submissions welcome, just send a PR, or [create an issue](https://github.com/codecrafters-io/build-your-own-x/issues/new) ⭐ 548,319 | 🐛 645 | 🌐 Markdown | 📅 2026-07-14
* Help us review [pending submissions](https://github.com/codecrafters-io/build-your-own-x/issues) ⭐ 548,319 | 🐛 645 | 🌐 Markdown | 📅 2026-07-14 by leaving comments and "reactions"
