...
* [**Java**: *Building Your Own Kafka-like System From Scratch: A Step-by-Step Guide*](https://github.com/buildthingsuseful/build-your-own-kafka) ⭐ 136 | 🐛 2 | 🌐 Java | 📅 2025-03-13

#### Build your own `3D Renderer`

* [**C++**: *How OpenGL works: software rendering in 500 lines of code*](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,256 | 🐛 4 | 🌐 C++ | 📅 2026-07-29
...
* [**Python**: *A Large Language Model (LLM)*](https://github.com/rasbt/LLMs-from-scratch) ⭐ 105,175 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-09-17
* [**Python**: *RAG for Document Search*](https://github.com/langchain-ai/rag-from-scratch) ⭐ 9,335 | 🐛 43 | 🌐 Jupyter Notebook | 📅 2025-06-26
...
* [**Python**: *Build Deep Learning From Scratch (reimplement PyTorch internals across 34 stages)*](https://github.com/roiamiel1/Build-Deep-Learning-From-Scratch) ⭐ 53 | 🐛 0 | 🌐 Python | 📅 2026-07-11
...
* [**C**: *How to create an OS from scratch*](https://github.com/cfenollosa/os-tutorial) ⭐ 30,711 | 🐛 130 | 🌐 C | 📅 2026-02-04
* [**C**: *Learning operating system development using Linux kernel and Raspberry Pi*](https://github.com/s-matyukevich/raspberry-pi-os) ⭐ 13,939 | 🐛 66 | 🌐 C | 📅 2024-03-29
...
* [**(any)**: *mal - Make a Lisp*](https://github.com/kanaka/mal#mal---make-a-lisp) ⭐ 10,733 | 🐛 55 | 🌐 Assembly | 📅 2025-10-22
...
* [**C**: *Build Your Own Shell*](https://github.com/tokenrove/build-your-own-shell) ⭐ 513 | 🐛 7 | 🌐 Tcl | 📅 2024-02-28
...
* [**JavaScript**: *JavaScript Algorithms and Data Structures*](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,764 | 🐛 405 | 🌐 JavaScript | 📅 2026-07-26
* [**C++**: *Build your own VR headset for $200*](https://github.com/relativty/Relativ) ⭐ 7,244 | 🐛 28 | 🌐 C++ | 📅 2024-07-21
* [**Rust**: *Building a DNS server in Rust*](https://github.com/EmilHernvall/dnsguide/blob/master/README.md) ⭐ 4,669 | 🐛 6 | 📅 2025-04-28
...
* Submissions welcome, just send a PR, or [create an issue](https://github.com/codecrafters-io/build-your-own-x/issues/new) ⭐ 547,970 | 🐛 643 | 🌐 Markdown | 📅 2026-07-14
* Help us review [pending submissions](https://github.com/codecrafters-io/build-your-own-x/issues) ⭐ 547,970 | 🐛 643 | 🌐 Markdown | 📅 2026-07-14 by leaving comments and "reactions"

## Origins & License

[![CC0](https://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)

This repository is the work of [many contributors](https://github.com/codecrafters-io/build-your-own-x/graphs/contributors) ⭐ 547,970 | 🐛 643 | 🌐 Markdown | 📅 2026-07-14. It was started by [Daniel Stefanovic](https://github.com/danistefanovic), and is now maintained by [CodeCrafters, Inc.](https://codecrafters.io) To the extent possible under law, [CodeCrafters, Inc.](https://codecrafters.io) has waived all copyright and related or neighboring rights to this work.
