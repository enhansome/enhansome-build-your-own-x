...
* [**C++**: *How OpenGL works: software rendering in 500 lines of code*](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,258 | 🐛 4 | 🌐 C++ | 📅 2026-07-29
...
* [**Python**: *A Large Language Model (LLM)*](https://github.com/rasbt/LLMs-from-scratch) ⭐ 105,214 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-09-17
* [**Python**: *RAG for Document Search*](https://github.com/langchain-ai/rag-from-scratch) ⭐ 9,341 | 🐛 43 | 🌐 Jupyter Notebook | 📅 2025-06-26
...
* [**JavaScript**: *A DIY guide to build your own React*](https://github.com/hexacta/didact) ⭐ 6,769 | 🐛 29 | 🌐 JavaScript | 📅 2026-01-31
...
* [**C**: *How to create an OS from scratch*](https://github.com/cfenollosa/os-tutorial) ⭐ 30,710 | 🐛 129 | 🌐 C | 📅 2026-02-04
...
* [**Verilog**: *From Blinker to RISC-V*](https://github.com/BrunoLevy/learn-fpga/tree/master/FemtoRV/TUTORIALS/FROM_BLINKER_TO_RISCV) ⭐ 3,687 | 🐛 59 | 🌐 C++ | 📅 2025-11-18
...
* [**JavaScript**: *JavaScript Algorithms and Data Structures*](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,774 | 🐛 405 | 🌐 JavaScript | 📅 2026-07-26
* [**C++**: *Build your own VR headset for $200*](https://github.com/relativty/Relativ) ⭐ 7,244 | 🐛 28 | 🌐 C++ | 📅 2024-07-21
* [**Rust**: *Building a DNS server in Rust*](https://github.com/EmilHernvall/dnsguide/blob/master/README.md) ⭐ 4,670 | 🐛 6 | 📅 2025-04-28
...
* Submissions welcome, just send a PR, or [create an issue](https://github.com/codecrafters-io/build-your-own-x/issues/new) ⭐ 548,143 | 🐛 645 | 🌐 Markdown | 📅 2026-07-14
* Help us review [pending submissions](https://github.com/codecrafters-io/build-your-own-x/issues) ⭐ 548,143 | 🐛 645 | 🌐 Markdown | 📅 2026-07-14 by leaving comments and "reactions"
