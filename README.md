...
* [**C++**: *How OpenGL works: software rendering in 500 lines of code*](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,211 | 🐛 4 | 🌐 C++ | 📅 2026-07-29
...
* [**Python**: *A Large Language Model (LLM)*](https://github.com/rasbt/LLMs-from-scratch) ⭐ 104,676 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-09-01
* [**Python**: *RAG for Document Search*](https://github.com/langchain-ai/rag-from-scratch) ⭐ 9,285 | 🐛 40 | 🌐 Jupyter Notebook | 📅 2025-06-26
...
* [**(any)**: *mal - Make a Lisp*](https://github.com/kanaka/mal#mal---make-a-lisp) ⭐ 10,729 | 🐛 54 | 🌐 Assembly | 📅 2025-10-22
...
* [**JavaScript**: *JavaScript Algorithms and Data Structures*](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,672 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26
...
* Submissions welcome, just send a PR, or [create an issue](https://github.com/codecrafters-io/build-your-own-x/issues/new) ⭐ 546,297 | 🐛 639 | 🌐 Markdown | 📅 2026-07-14
* Help us review [pending submissions](https://github.com/codecrafters-io/build-your-own-x/issues) ⭐ 546,297 | 🐛 639 | 🌐 Markdown | 📅 2026-07-14 by leaving comments and "reactions"

## Origins & License

[![CC0](https://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)

This repository is the work of [many contributors](https://github.com/codecrafters-io/build-your-own-x/graphs/contributors) ⭐ 546,297 | 🐛 639 | 🌐 Markdown | 📅 2026-07-14. It was started by [Daniel Stefanovic](https://github.com/danistefanovic), and is now maintained by [CodeCrafters, Inc.](https://codecrafters.io) To the extent possible under law, [CodeCrafters, Inc.](https://codecrafters.io) has waived all copyright and related or neighboring rights to this work.
